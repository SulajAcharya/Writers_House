                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="<?php echo action_form("q=".$genre["genre_id"]); ?>" class="form-group" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <button type="submit" id="change" name="change" class="btn btn-primary">Edit <span class="fa fa-edit"></span></button>
                                </div>
                                <div class="col-md-2">
                                    <a href="/admin/genre/" id="delete" name="delete" class="btn btn-danger">Cancel <span class="fa fa-close"></span></a>
                                </div>
                            </div>
                        </form>
                    </div>
