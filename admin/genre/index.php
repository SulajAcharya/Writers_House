                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="/admin/genre/delete_genre?q=<?php echo $genre["genre_id"]; ?>" class="btn btn-sm btn-danger mx-auto d-block col-6" id="delete" name="delete"><span class="fa-solid fa-trash"></span> Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                        $number += 1;
